...
*   **Explicit Fixes Only:** Do not apply code fixes or modifications unless explicitly directed to do so by the user. Observations of bugs or errors should be reported as Inquiries first.
